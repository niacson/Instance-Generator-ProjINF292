...
# Extras:
Para sistemas linux se puede automatizar la compilacion y la creacion de 5 instancias de todos los tamaños mediante el archivo **runner.sh**, para poder hacer uso de este es importante
